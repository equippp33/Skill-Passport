...
export const mr: Messages = {
  ...
  instructions: {
    ...
    duration: "एकूण साधारण {minutes} मिनिटे, {count} प्रश्नांसाठी.",
    skillsCovered:
  ...
  interview: {
    ...
    recorded: "रेकॉर्ड झाले — ऐका किंवा पाठवा",
    ...
    keepSpeaking: "तुमचे उत्तर पूर्ण झाल्यावर पुढील बटण दाबा.",
    leftTab:
    ...
    listening: "ऐकत आहे…",
    previousTranscript: "तुमच्या मागील उत्तरात आम्हाला हे ऐकू आले",
