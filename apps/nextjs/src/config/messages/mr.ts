...
export const mr: Messages = {
  ...
  instructions: {
    ...
    backgroundTitle: "तुम्ही काय करता?",
    backgroundBody:
      "तुम्ही शिकत आहात की काम करत आहात? कुठे आणि काय करता ते सांगा — एक-दोन ओळी पुरेत. तुमचे प्रश्न याच्याच आधारे तयार होतात, त्यामुळे जेवढं खरं लिहाल तेवढे प्रश्न चांगले जुळतील.",
    courseLabel: "कोर्स किंवा शिक्षण",
    coursePlaceholder: "उदा. B.Com शेवटचं वर्ष",
    experienceLabel: "याआधी काही काम केलंय?",
    experiencePlaceholder:
      "उदा. काकांच्या कपड्यांच्या दुकानात weekends. नसेल तर रिकामं ठेवा.",
    languageTitle: "तुमची भाषा निवडा",
    languageBody:
      "पूर्ण interview — प्रश्न, तुमची उत्तरं आणि तुमचा अहवाल — तुम्ही निवडलेल्या भाषेतच असेल. तुम्ही ती interview दरम्यान कधीही बदलू शकता.",
    needLanguage: "पुढे जाण्यासाठी भाषा निवडा.",
