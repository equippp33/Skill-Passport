...
export const hi: Messages = {
  ...
  instructions: {
    ...
    backgroundTitle: "आप क्या करते हैं?",
    backgroundBody:
      "आप पढ़ाई कर रहे हैं या काम? बताइए कहाँ और क्या करते हैं — एक-दो लाइन काफी हैं। आपके सवाल इसी के आसपास बनते हैं, इसलिए जितना सही लिखेंगे उतने बेहतर सवाल मिलेंगे।",
    courseLabel: "कोर्स या पढ़ाई",
    coursePlaceholder: "जैसे: B.Com आखिरी साल",
    experienceLabel: "पहले कोई काम किया है?",
    experiencePlaceholder:
      "जैसे: चाचा की कपड़े की दुकान पर weekends. न किया हो तो खाली छोड़ें.",
    languageTitle: "अपनी भाषा चुनें",
    languageBody:
      "पूरा interview — सवाल, आपके जवाब और आपकी रिपोर्ट — उसी भाषा में होगा जो आप चुनेंगे। इसे आप interview के दौरान कभी भी बदल सकते हैं।",
    needLanguage: "आगे बढ़ने के लिए भाषा चुनें।",
